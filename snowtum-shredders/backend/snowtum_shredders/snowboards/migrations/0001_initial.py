    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boardbag_sku', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
            options={
                'db_table': 'boardbag',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('headgear_sku', models.DecimalField(decimal_places=2, max_digits=10)),
            ],
            options={
                'db_table': 'headgear',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tshirt_sku', models.DecimalField(decimal_places=2, max_digits=10)),
                ('tshirt', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snowboards.tshirt')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('snowboard_sku', models.DecimalField(decimal_places=2, max_digits=10)),
                ('snowboard', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snowboards.snowboard')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hoodie_sku', models.DecimalField(decimal_places=2, max_digits=10)),
                ('hoodie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snowboards.hoodie')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('boardbag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='snowboards.boardbag')),
            ],
            options={
